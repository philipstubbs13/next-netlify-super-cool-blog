...
var halfmoon = {
    ...
    deactivateAllDropdownToggles: function () {
        for (
            var e = document.querySelectorAll("[data-toggle='dropdown'].active"), t = 0;
            t < e.length;
            t++
        )
...
function halfmoonOnDOMContentLoaded() {
    halfmoon.pageWrapper ||
        ...
        document.documentElement.clientWidth <= 768
            ? halfmoon.pageWrapper &&
              (halfmoon.pageWrapper.getAttribute('data-show-sidebar-onload-sm-and-down') ||
                  halfmoon.pageWrapper.setAttribute('data-sidebar-hidden', 'hidden'))
            : halfmoon.pageWrapper &&
              'overlayed-all' === halfmoon.pageWrapper.getAttribute('data-sidebar-type') &&
              halfmoon.pageWrapper.setAttribute('data-sidebar-hidden', 'hidden'),
        document.addEventListener(
            ...
            function (e) {
                var t,
                    ...
                    a = e,
                    s = e.target;
                s.matches("[data-toggle='dropdown']") || s.matches("[data-toggle='dropdown'] *")
                    ...
                    : s.matches('.dropdown-menu *') || halfmoon.deactivateAllDropdownToggles(),
                    (s.matches(".alert [data-dismiss='alert']") ||
                        s.matches(".alert [data-dismiss='alert'] *")) &&
                        (s.matches(".alert [data-dismiss='alert'] *") &&
                            (s = s.closest(".alert [data-dismiss='alert']")),
                        s.parentNode.classList.add('dispose')),
                    (s.matches("[data-toggle='modal']") || s.matches("[data-toggle='modal'] *")) &&
